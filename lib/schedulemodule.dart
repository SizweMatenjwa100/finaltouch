...
class _SchedulemoduleState extends State<Schedulemodule> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text("Step 4: Schedule", style: GoogleFonts.manrope(fontSize: 20, fontWeight: FontWeight.bold),
        ),
        Padding(
        ...
        Row(
          ...
          children: [
            ...
            SizedBox(width: 210,),
            Text("R450",style: GoogleFonts.manrope(fontSize: 16, fontWeight: FontWeight.normal),)
          ],
        ),
        SizedBox(height: 20,),
        SizedBox(
