// lib/presentation/booking/pages/schedulemodule.dart - UPDATED WITH PAYMENT INTEGRATION
...
import '../../payments/pages/payment_review_screen.dart';
...
class _SchedulemoduleState extends State<Schedulemodule> {
  ...
  void _proceedToPayment() {
    ...
    print("🗓️ Proceeding to payment review for location: ${widget.locationId}");
    print("💰 Total price: ${PricingService.formatPrice(priceBreakdown.total)}");

    // Navigate to payment review screen instead of direct payment
    Navigator.push(
      context,
      MaterialPageRoute(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _selectedTime.isNotEmpty ? _proceedToPayment : null,
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _selectedTime.isNotEmpty
                          ? const Color(0xFF1CABE3)
                          : Colors.grey.shade300,
                      ...
                      elevation: _selectedTime.isNotEmpty ? 4 : 0,
                    ),
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(
                          _selectedTime.isNotEmpty ? "Proceed to Payment" : "Please select time",
